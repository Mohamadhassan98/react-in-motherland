...
export default function initStrings(locale: string) {
    i18n.translations = {
        en: {
            ...
            insertName: "Name (Mandatory)",
            insertBio: "Bio",
            insertUsername: "Username",
            selectBirthDate: "Birth date",
        ...
        fa: {
            ...
            insertName: "نام (اجباری)",
            insertBio: "بیو",
            insertUsername: "نام کاربری",
            selectBirthDate: "تاریخ تولد",
            search: "جستجو",
...
export const i17n = {
    ...
    camera: I18nManager.isRTL ? "دوربین" : "camera",
    gallery: I18nManager.isRTL ? "گالری" : "gallery",
...
export let chatList = [
    ...
    {
        FirstName: "کلاس تعامل انسان و ماشین",
        LastName: "",
        message: "سلام؟؟؟؟؟  سلام سلام سلام سلام سلام ",
        notification: 150,
        mute: false,
