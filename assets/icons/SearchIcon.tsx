...
function Icons8SearchIcon({style}: SvgIconProps) {
    return (
        <SvgIcon style={style}>
            <Svg viewBox='0 0 48 48' width='100%' height='100%'>
                <Path fill='#616161' d='M29.18 31.99l2.829-2.828 12.02 12.02-2.828 2.829z' />
                <Path fill='#616161' d='M20 4a16 16 0 100 32 16 16 0 100-32z' />
                <Path fill='#37474F' d='M32.456 35.341l2.828-2.829 8.698 8.698-2.829 2.828z' />
                <Path fill='#64B5F6' d='M20 7a13 13 0 100 26 13 13 0 100-26z' />
                <Path
                    fill='#BBDEFB'
...
export default Icons8SearchIcon;
